...
VAST.Length.Restricted.Catch <- function(spLongName = 'petrale sole', Species = NULL, spShortName = NULL, Top.Prct = 15, Top.Years = 6, warehouseDownload = TRUE, dupYears = NULL, 
 ...
 if(runVAST) {
     ...
     if(runDiagnostics) {
          ...
          # Residuals
           try( FishStatsUtils::plot_residuals(Lat_i=Data_G[,'Lat'], Lon_i=Data_G[,'Lon'], TmbData=TmbData, Report=Report, Q=QQ, savedir=DateFile, MappingDetails=MapDetails_List[["MappingDetails"]],
