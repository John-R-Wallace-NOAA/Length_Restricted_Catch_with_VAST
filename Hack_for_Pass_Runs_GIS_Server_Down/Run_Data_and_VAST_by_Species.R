...
# Took data from runs without pass for those runs with pass since NCEI (formerly NGDC) website GIS server was down
Data_List <- list()

base::load("../WCGBTS_JV_3/2019-03-08_PTRL_DV_WCGBTS_LM21_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[1]]  <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-07_SABL_DV_WCGBTS_LM29_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[2]]  <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-07_DOVR_DV_WCGBTS_LM17_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[3]]  <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-07_EGLS_DV_WCGBTS_LM16_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[4]]  <- list(DatG, depthCovar, Ages, LenMin) 
base::load("../WCGBTS_JV_3/2019-03-07_PDAB_DV_WCGBTS_LM13_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[5]]  <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-08_ARTH_DV_WCGBTS_LM22_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[6]]  <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-08_PWHT_DV_WCGBTS_LM26_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[7]]  <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-08_LCOD_DV_WCGBTS_LM25_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[8]]  <- list(DatG, depthCovar, Ages, LenMin) 
base::load("../WCGBTS_JV_3/2019-03-08_GREN_DV_WCGBTS_LM3_v5_5_0_Rho=3_AS_nx=600/Image.RData");  Data_List[[9]]  <- list(DatG, depthCovar, Ages, LenMin) 
base::load("../WCGBTS_JV_3/2019-03-11_SSPN_DV_WCGBTS_LM8_v5_5_0_Rho=3_AS_nx=600/Image.RData");  Data_List[[10]] <- list(DatG, depthCovar, Ages, LenMin)
base::load("../WCGBTS_JV_3/2019-03-08_LSPN_DV_WCGBTS_LM7_v5_5_0_Rho=3_AS_nx=600/Image.RData");  Data_List[[11]] <- list(DatG, depthCovar, Ages, LenMin) 
base::load("../WCGBTS_JV_3/2019-03-08_DBRK_DV_WCGBTS_LM15_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[12]] <- list(DatG, depthCovar, Ages, LenMin)     
base::load("../WCGBTS_JV_3/2019-03-08_SNOS_DV_WCGBTS_LM10_v5_5_0_Rho=3_AS_nx=600/Image.RData"); Data_List[[13]] <- list(DatG, depthCovar, Ages, LenMin)  
     ...
     if(DATA)
       VAST.Length.Restricted.Catch( SpList[[i]]$SP, Top.Prct = 15, Top.Years = 6, warehouseDownload = TRUE, LenMaxAges = SpList[[i]]$LenMaxAges, RawDataPlots = TRUE, runVAST = FALSE, 
        ...
        try(VAST.Length.Restricted.Catch( SpList[[i]]$SP, Top.Prct = 15, Top.Years = 6, warehouseDownload = FALSE, LenMaxAges = SpList[[i]]$LenMaxAges, LatMax = SpList[[i]]$LatMax,
               ...
               rhoConfig = j, Extra.Group.Size = SpList[[i]]$Extra.Group.Size, Data_List = Data_List[[i]]))
   }
