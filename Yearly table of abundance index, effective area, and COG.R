...
# IndexTable <- SpatialDeltaGLMM::PlotIndex_Fn(DirName=DateFile, TmbData=TmbData, Sdreport=Opt$SD, Year_Set=sort(unique(DatG$Year)), strata_names=strata.limits[,1], 
#                   use_biascorr=TRUE, width = 11, height = 8)$Table
